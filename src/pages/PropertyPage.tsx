...
export default function PropertyPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50">
      <Seo title={language === 'sr' ? 'Detalji nekretnine' : 'Property Details'} />
      <Header />
      ...
      <main className="pt-24 pb-16">
        {isLoading ? (
          ...
          <div className="container mx-auto px-4 text-center text-red-500 py-10">
            {error}
          </div>
        ) : !property ? (
          <div className="container mx-auto px-4 text-center text-gray-500 py-10">
            {language === 'sr' ? 'Nekretnina nije pronađena' : 'Property not found'}
          </div>
        ) : (
          <>
                    ...
                    <div className="lg:col-span-1">
                      <div ref={agentCardWrapperRef} className="relative">
                        <div ref={agentCardRef} className="w-full z-20">
                          <ContactAgentCard agent={property?.agent || defaultAgent} />
                        </div>
                      </div>
                    </div>
                  </div>
